      ...
      <AnimatePresence>
        {activated && (
          ...
          >
            ...
            >
              <p className="font-mono text-2xl font-bold tracking-[0.2em] sm:text-4xl" style={{ color: 'var(--accent-active)' }}>
                CHEAT CODE ACTIVATED
              </p>
              <a
                href="mailto:christian@bourlier.ai"
                className="pointer-events-auto mt-3 block text-center font-mono text-sm transition-colors hover:text-accent-active"
