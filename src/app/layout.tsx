...
export const metadata: Metadata = {
  ...
  description:
    "I architect production AI systems where autonomous agents perform reliable, governed work at scale. Multi-agent orchestration. Full audit coverage.",
  keywords: [
  ...
  openGraph: {
    ...
    title: "Christian Bourlier — AI Systems Architect",
    description: "Bounded AI systems that ship. 4 production systems. 100% audit coverage. 0 uncontained failures.",
